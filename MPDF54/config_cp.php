...
function GetLangOpts($llcc, $adobeCJK) {
	...
	//	else { $unifonts = ""; }
	  ...
	  CASE "th":  $unifonts = "garuda,garudaB,garudaI,garudaBI,norasi,norasiB,norasiI,norasiBI";  break;
          // THAI sarabun
	  CASE "th_sarabun":  $unifonts = "THSaraban,THSarabanB,THSarabanI,THSarabanBI";  break;
          // THAI angsana
	  CASE "th_angsana":  $unifonts = "AngsanaUPC,AngsanaUPCB,AngsanaUPCI,AngsanaUPCBI";  break;
