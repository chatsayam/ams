 ...
 * @property TbInstitution[] $tbInstitutions
 */
class TbDivision extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('division', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('division_id, division', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tbInstitutions' => array(self::HAS_MANY, 'TbInstitution', 'tb_division_division_id'),
		);
	}
