...
class Expenditure extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('exName', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('exID, exName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'stockMaterials' => array(self::HAS_MANY, 'StockMaterial', 'expenditure_exID'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('exName',$this->exName,true);
