...
class Division extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('divName', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('divID, divName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'stockMaterials' => array(self::HAS_MANY, 'StockMaterial', 'division_divID'),
			'tranferHistories' => array(self::HAS_MANY, 'TranferHistory', 'division_divID'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('divName',$this->divName,true);
