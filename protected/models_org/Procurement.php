...
class Procurement extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('prName', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('prID, prName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'stockMaterials' => array(self::HAS_MANY, 'StockMaterial', 'procurement_prID'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('prName',$this->prName,true);
