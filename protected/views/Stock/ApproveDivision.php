...
<div class="page-body" ng-controller="mainController">
    <div class="row">
        <div class="col-md-12">
            ...
            <button class="btn btn-info" ng-click="warning()" type="button"><span class="glyphicon glyphicon-pencil"></span> แก้ไขข้อมูล</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </div>
    <hr>
    <div class="row">
...
<?php
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/js/ApproveDivision.js', CClientScript::POS_END);