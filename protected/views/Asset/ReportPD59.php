                    ...
                    <td colspan="4" align="center" class="table1">
                        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="table2">
                            ...
                            <tr height="370">
                                ...
                                <td align="right" valign="top" class="htb59">
                                    <?= number_format($model[0]['price_per'] * 1, 2) ?>
                                </td>
                                <td align="center" class="htb59">
                                    &nbsp;
                                </td>
                                <td align="center" valign="top" class="htb59">
                                    <?= $model[0]['lifetime'] ?>&nbsp;ปี<br>อย่างมีประสิทธิภาพ
                                </td>
                                <td align="center" valign="top" class="htb59">

                                    <?php
                                    $per = $model[0]['lifetime'] * 365;
                                    $per = $model[0]['price_per'] / $per;
                                    echo number_format($per * 365, 2);
                                    ?>
                                </td>
                                <td align="center" valign="top" class="htb59">

                                    <?php
                                    $day = $Nfunc->countDay($model[0]['date_examine'], date('Y-m-d'));
                                    $per = $model[0]['lifetime'] * 365;
                                    $per = $model[0]['price_per'] / $per;
                                    $sum = $per * $day;
                                    if ($sum <= $model[0]['price_per'] - 1) {
                                        echo number_format($sum, 2);
                                    } else {
                                        echo number_format($model[0]['price_per'] - 1, 2);
                                    }
                                    ?>
                                </td>
                                <td align="left" valign="top" class="htb59">
                                    <?php
                                    if ($model[0]['state'] != 'คงเหลือหนึ่งบาท') {

                                        $avg = $model[0]['price_per'] - $sum;
                                        ...
                                        echo '1.00';
                                        $this->changeStatus($idot,'คงเหลือหนึ่งบาท');
                                    }
                                    ?>
                                </td>
                                <td align="left" valign="top" class="htb59">
