<div  ng-controller="mainController">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header"><i class="glyphicon glyphicon-hand-right"></i> <span id="topicPd44Plus">รายงานประจำปีครุภัณฑ์ต่ำเกณฑ์</span></h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <?php
...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/js/ReportLow.js', CClientScript::POS_END); ?>
