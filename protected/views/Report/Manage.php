<div  ng-controller="mainController">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header"><i class="glyphicon glyphicon-hand-right"></i> <span id="topicPd44Plus">จัดการรายงานประจำปี</span></h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                    ...
                    <div class="row">
                        <div class="well">
                            ...
                            <div class="row" style="text-align: right;">
                                <button class="btn btn-warning" ng-click="sell()"  type="button"><span class="glyphicon glyphicon-star"></span> ขอจำหน่าย</button>&nbsp;&nbsp;&nbsp;
                            </div>
                        </div>
                    </div>
...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/js/ReportManage.js', CClientScript::POS_END); ?>
